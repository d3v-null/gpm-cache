...
from .core import (BadLoginException, PlaylistNotFoundException, TrackInfo, main, to_safe_filename,
                   to_safe_print)
...
class TestTrackInfo(unittest.TestCase):
    ...
    track_info = {
        ...
        u'albumArtRef': [{
            ...
            u'kind':
            u'sj#imageRef',
            u'url': (u'http://lh3.googleusercontent.com/'
                     u'JPIzh3RwQ8E3tuW9iiCd8SSA7xSDGwHeplgP2d903AmibiDpX5_zkPa2rDFsYheTkeyi_nA7lw')
        }],
        u'albumArtist':
        u'Moonbase Commander',
        u'albumAvailableForPurchase':
        False,
        u'albumId':
        u'B52ucw7kgew7axvye5vldk6rxty',
        u'artist':
        u'Moonbase Commander',
        u'artistArtRef': [{
            u'aspectRatio':
        ...
        u'sj#track',
        u'nid':
        u'6zn3up2um24dxoggvac6obj7ay',
        u'playCount':
        1,
        u'storeId':
        u'T6zn3up2um24dxoggvac6obj7ay',
        u'title':
        u'Southpaw',
        u'trackAvailableForPurchase':
        True,
        u'trackAvailableForSubscription':
        True,
        u'trackNumber':
        1,
        u'trackType':
