...
VERSION = "0.1"
DESCRIPTION = "An innocuous little script that caches information about a GPM playlist using GMusicAPI"
...
setup(
    ...
    url='https://github.com/derwentx/gpm-cache',  # Optional
